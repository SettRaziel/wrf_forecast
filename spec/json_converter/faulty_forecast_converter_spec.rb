require "spec_helper"
require "time"
require_relative "./faulty_forecast_converter"

describe WrfForecast::JsonConverter::FaultyForecastJsonConverter do
  ...
  describe ".convert" do
    context "given a meteogram output file" do
      it "read it, create the json converter object and fail at converting to the abstract methods" do
        ...
        converter = WrfForecast::JsonConverter::FaultyForecastJsonConverter.
