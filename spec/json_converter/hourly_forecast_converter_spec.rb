  ...
  describe ".convert" do
    context "given a meteogram output file" do
      it "read it and create the correct json output" do
        ...
        converter = WrfForecast::JsonConverter::HourlyForecastJsonConverter.
                    new(wrf_handler, forecast_handler.repository, forecast_handler.threshold_handler.warnings)
